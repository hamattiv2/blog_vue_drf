...
<script>
    ...
    export default {
        ...
        created() {
            this.$axios(this.$categoryUrl)
            .then(response => {
                this.UPDATE_CATEGORY(response.data)
            })
        },
        computed: {
        ...
        methods: {
            ...mapActions(['UPDATE_CATEGORY', 'UPDATE_POSTS']),
            search() {
                console.log(this.$postUrl)
                this.$axios(`${this.$postUrl}?keyword=${this.keyword}&category=${this.selected}`)
                .then(response => {
